...
import com.dsource.idc.jellowintl.Presentor.CustomIconsDao;
...
@Database(entities = {CategoryPreference.class, BoardModel.class, VerbiageModel.class, CustomIconsModel.class}, version = 4, exportSchema = false)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract CustomIconsDao customIconsDao();
}
