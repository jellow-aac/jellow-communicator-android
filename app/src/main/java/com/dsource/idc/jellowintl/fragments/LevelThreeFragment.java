...
import com.dsource.idc.jellowintl.fragments.adapters.LevelThreeAdapter;
...
public class LevelThreeFragment extends BaseFragment implements BasicCustomIconsChangedListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getLevelActivity().setVisibleAct(LevelThreeFragment.class.getSimpleName());
        ...
        if (view.findViewById(R.id.parent).getTag() != null &&
                view.findViewById(R.id.parent).getTag().toString().equals("large")) {
    ...
    private void highlightSearchedItem() {
        ...
        final int sortedIndex = getSortedIndex(getArguments().getInt(getString(R.string.search_parent_2)));
    ...
    public void onPause() {
        ...
        stopMeasuring("LevelThreeFragment");
    }
    ...
    private void initializeLayoutViews(View view) {
        ...
        switch (getSession().getGridSize()){
            ...
            case GlobalConstants.FOUR_ICONS_PER_SCREEN:
                mRecyclerView.setLayoutManager(new CustomGridLayoutManager(requireContext(), 2,3));
            ...
            case GlobalConstants.NINE_ICONS_PER_SCREEN:
                mRecyclerView.setLayoutManager(new CustomGridLayoutManager
                        (requireContext(), 3, getSession().getGridSize()));
                break;
        }
        ...
        if (level3IconObjects != null && ((getSession().getBasicCustomIconAddState() && level3IconObjects.length == 1) ||
    ...
    private void initializeRecyclerViewAdapter() {
        ...
        String savedString = PreferencesHelper.getPrefString(getAppDatabase(),
                getIconCode(LanguageFactory.getCurrentLanguageCode(requireContext()),
    ...
    public boolean isCategoryWithPreference() {
        String iconCode = IconFactory.getIconCode(
                LanguageFactory.getCurrentLanguageCode(requireContext()), mLevelOneItemPos, mLevelTwoItemPos);
        ...
        mRecyclerView.addOnChildAttachStateChangeListener(new RecyclerView.OnChildAttachStateChangeListener() {
            ...
            public void onChildViewAttachedToWindow(View view) {
                ...
                if(mRecyclerItemsViewList.contains(view) && mSelectedItemAdapterPos > GlobalConstants.NOT_SELECTED &&
                        ...
                        LevelUiUtils.setBorderToCategoryIcon(requireActivity(), view,
    ...
    public void onEditIconClicked(int position) {
        ...
        bundle.putInt(getString(R.string.level_2_item_pos_tag), mLevelTwoItemPos);
        bundle.putString(BASIC_ICON_ID, level3IconObjects[position].getEvent_Tag());
    ...
    public void onDeleteIconClicked(int position) {
        final DialogCustom dialog = new DialogCustom(requireActivity());
        ...
        dialog.setOnPositiveClickListener(new DialogCustom.OnPositiveClickListener() {
            ...
            public void onPositiveClickListener() {
                CustomBasicIconHelper.deleteCustomBasicIcon(requireActivity(),
