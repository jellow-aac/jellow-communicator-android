...
public class FeedbackFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        requireActivity().getOnBackPressedDispatcher().addCallback(getViewLifecycleOwner(), new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                if (!NavHostFragment.findNavController(FeedbackFragment.this).popBackStack()) {
                    NavHostFragment.findNavController(FeedbackFragment.this).navigate(R.id.levelOneFragment);
                }
            }
        });
    }
    ...
    public void addListenerOnRatingBar(View view) {
        ...
        mRatingEasyToUse.setOnRatingBarChangeListener((ratingBar, rating, fromUser) -> strEaseOfUse = rating);
        pictures.setOnRatingBarChangeListener((ratingBar, rating, fromUser) -> stClearPicture = rating);
        voice.setOnRatingBarChangeListener((ratingBar, rating, fromUser) -> strClearVoice = rating);
        navigate.setOnRatingBarChangeListener((ratingBar, rating, fromUser) -> strEaseToNav = rating);
    }
        ...
        if(strEaseOfUse!=0f&&stClearPicture!=0f&&strClearVoice!=0f&&strEaseToNav!=0f) {
            ...
            mRef.child(mRef.push().getKey()).setValue(map)
                .addOnSuccessListener(aVoid -> {
                    ...
                    .addOnFailureListener(e -> NavHostFragment.findNavController(FeedbackFragment.this).popBackStack());
        }else{
