...
public class ActivitySequenceFragment extends BaseFragment {
    ...
    private View mBorderView1, mBorderView2, mBorderView3;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_sequence, container, false);
    }
    ...
    private void highlightSearchedItem() {
        ...
        int iconIndex = getArguments().getInt(getString(R.string.search_parent_2));
    ...
    public void onDestroyView() {
        ...
        mIvCategoryIcon1 = null;
        mIvCategoryIcon2 = null;
        mIvCategoryIcon3 = null;
        mTvCategory1Caption = null;
        mTvCategory2Caption = null;
        mTvCategory3Caption = null;
        mBorderView1 = null;
        mBorderView2 = null;
        mBorderView3 = null;
        super.onDestroyView();
    ...
    private void initializeLayoutViews(View view){
        ...
        mBtnNext = view.findViewById(R.id.forward);
        mBtnBack = view.findViewById(R.id.backward);
        mTvHeading = view.findViewById(R.id.tt1);
        mTvCategory1Caption = view.findViewById(R.id.bt1);
        mTvCategory2Caption = view.findViewById(R.id.bt2);
        mTvCategory3Caption = view.findViewById(R.id.bt3);

        if(isAccessibilityTalkBackOn((AccessibilityManager) requireActivity().getSystemService(Context.ACCESSIBILITY_SERVICE))) {
            Typeface tf = ResourcesCompat.getFont(requireContext(), R.font.mukta_semibold);
            mTvCategory1Caption.setTypeface(tf);
            mTvCategory2Caption.setTypeface(tf);
            mTvCategory3Caption.setTypeface(tf);
        }
        mIvCategoryIcon1 = view.findViewById(R.id.image1);
        mIvCategoryIcon2 = view.findViewById(R.id.image2);
        mIvCategoryIcon3 = view.findViewById(R.id.image3);
        mIvArrowLeft = view.findViewById(R.id.arrow1);
        mIvArrowRight = view.findViewById(R.id.arrow2);
        ...
        mBorderView1 = view.findViewById(R.id.borderView1);
        mBorderView2 = view.findViewById(R.id.borderView2);
        mBorderView3 = view.findViewById(R.id.borderView3);
    }
            ...
            public void onClick(View v) {
                ...
                if (seqIconObjects.length < count + 3) {
                    ...
                    if (mLevelTwoItemPos == 0 || mLevelTwoItemPos == 2) {
                        setImageUsingGlide(getIconPath(requireActivity(),
    ...
    private void initCategoryIcon1Listener() {
        mIvCategoryIcon1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mFlgHideExpBtn == 1) {
                    hideExpressiveBtn(true);
                    setBorderToView(mBorderView1,GlobalConstants.NOT_SELECTED);
                    mFlgHideExpBtn = 0;
                    if (!isAccessibilityTalkBackOn((AccessibilityManager) requireActivity().getSystemService(Context.ACCESSIBILITY_SERVICE))) {
                ...
                // set the border of category icon 1 and showDialog expressive buttons
                    ...
                    resetCategoryIconBorders();
                    LevelUiUtils.setExpressiveIconPressedState(expressiveBtn, GlobalConstants.NO_EXPR);
                    setBorderToView(mBorderView1, 6);
                }
    ...
    private void initCategoryIcon2Listener() {
        mIvCategoryIcon2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mFlgHideExpBtn == 2) {
                    hideExpressiveBtn(true);
                    setBorderToView(mBorderView2,GlobalConstants.NOT_SELECTED);
                    mFlgHideExpBtn = 0;
                    if (!isAccessibilityTalkBackOn((AccessibilityManager) requireActivity().getSystemService(Context.ACCESSIBILITY_SERVICE))) {
                    ...
                    resetCategoryIconBorders();
                    LevelUiUtils.setExpressiveIconPressedState(expressiveBtn, GlobalConstants.NO_EXPR);
                    setBorderToView(mBorderView2,6);
                }
                mIvBack.setImageResource(R.drawable.back);
                if (isAccessibilityTalkBackOn((AccessibilityManager) requireActivity().getSystemService(Context.ACCESSIBILITY_SERVICE))) {
    ...
    private void initCategoryIcon3Listener() {
        mIvCategoryIcon3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mFlgHideExpBtn == 3) {
                    hideExpressiveBtn(true);
                    setBorderToView(mBorderView3, GlobalConstants.NOT_SELECTED);
                    mFlgHideExpBtn = 0;
                    if (!isAccessibilityTalkBackOn((AccessibilityManager) requireActivity().getSystemService(Context.ACCESSIBILITY_SERVICE))) {
                        mUec.createSendFbEventFromTappedView(12,
                    ...
                    resetCategoryIconBorders();
                    LevelUiUtils.setExpressiveIconPressedState(expressiveBtn, GlobalConstants.NO_EXPR);
                    setBorderToView(mBorderView3, 6);
                }
                mIvBack.setImageResource(R.drawable.back);
                if (isAccessibilityTalkBackOn((AccessibilityManager) requireActivity().getSystemService(Context.ACCESSIBILITY_SERVICE))) {
        ...
        String[] categoryNavButton;
            try {
                ...
                categoryNavButton = new String[] {
                        LanguageFactory.getCurrentLanguageCode(requireContext()) + "04MS.mp3",
                        LanguageFactory.getCurrentLanguageCode(requireContext()) + "05MS.mp3"
                };
            }
    ...
    private void setValueToViews() {
        ...
        mBtnBack.setEnabled(false);
        mBtnBack.setAlpha(GlobalConstants.DISABLE_ALPHA);
        mTvHeading.setAllCaps(!isAccessibilityTalkBackOn((AccessibilityManager) requireActivity().getSystemService(Context.ACCESSIBILITY_SERVICE)));
    ...
    private void setImageUsingGlide(String path, ImageView imgView) {
        Glide.with(requireActivity())
                .load(path+EXTENSION)
                .error(Glide.with(requireActivity()).load(getBasicCustomIconsPath(requireActivity(), new File(path).getName() + EXTENSION)))
    ...
    private void setBorderToIcon(int actionBtnIdx) {
        if (mFlgHideExpBtn == 1) {/*HERE*/
            setBorderToView(mBorderView1, actionBtnIdx);
        } else if (mFlgHideExpBtn == 2) {
            setBorderToView(mBorderView2, actionBtnIdx);
        } else if (mFlgHideExpBtn == 3) {
            setBorderToView(mBorderView3, actionBtnIdx);
        }
        switch (actionBtnIdx){
    ...
    private void setBorderToView(View borderView, int actionBtnIdx) {
        ...
        switch (actionBtnIdx) {
            case 0: gd.setColor(ContextCompat.getColor(requireContext(), R.color.colorLike)); break;
            case 1: gd.setColor(ContextCompat.getColor(requireContext(), R.color.colorDontLike)); break;
            case 2: gd.setColor(ContextCompat.getColor(requireContext(), R.color.colorYes)); break;
            case 3: gd.setColor(ContextCompat.getColor(requireContext(), R.color.colorNo)); break;
            case 4: gd.setColor(ContextCompat.getColor(requireContext(), R.color.colorMore)); break;
            case 5: gd.setColor(ContextCompat.getColor(requireContext(), R.color.colorLess)); break;
            case 6: gd.setColor(ContextCompat.getColor(requireContext(), R.color.colorSelect)); break;
            default: gd.setColor(ContextCompat.getColor(requireContext(), android.R.color.transparent));
        }
    }
    ...
    private void resetCategoryIconBorders() {
        if (mBorderView1 != null) {
            GradientDrawable gd = (GradientDrawable) mBorderView1.getBackground();
            gd.setColor(ContextCompat.getColor(requireContext(), android.R.color.transparent));
        }
        if (mBorderView2 != null) {
            GradientDrawable gd = (GradientDrawable) mBorderView2.getBackground();
            gd.setColor(ContextCompat.getColor(requireContext(), android.R.color.transparent));
        }
        if (mBorderView3 != null) {
            GradientDrawable gd = (GradientDrawable) mBorderView3.getBackground();
            gd.setColor(ContextCompat.getColor(requireContext(), android.R.color.transparent));
        }
    }
