...
//    private Button btnDone;
    private TextView tvIntroTitleStatic;
    private View ivMoveLeft, ivMoveRight;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getBaseActivity().setupActionBarTitle(view, View.GONE, getString(R.string.intro_to_jellow));
        ...
        if (view.findViewById(R.id.toolbar) != null) {
            ...
            if (tvIntroTitleStatic != null) {
                tvIntroTitleStatic.setTextColor(ContextCompat.getColor(requireContext(), R.color.white));
            }
        }
...
//        btnDone = view.findViewById(R.id.btnDone);
        tvIntroTitleStatic = view.findViewById(R.id.tv_intro_title_static);
        ivMoveLeft = view.findViewById(R.id.btnMoveLeft);
        ivMoveRight = view.findViewById(R.id.btnMoveRight);
        ...
        viewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                tvIntroTitleStatic.setText(titles[position]);
                ivMoveLeft.setVisibility(position == 0 ? View.GONE : View.VISIBLE);
                ivMoveRight.setVisibility(position == layouts.length - 1 ? View.GONE : View.VISIBLE);
...
//        });
        ...
        ivMoveLeft.setOnClickListener(v -> {
            if (viewPager.getCurrentItem() > 0) {
                viewPager.setCurrentItem(viewPager.getCurrentItem() - 1);
            }
        });

        ivMoveRight.setOnClickListener(v -> {
            if (viewPager.getCurrentItem() < layouts.length - 1) {
                viewPager.setCurrentItem(viewPager.getCurrentItem() + 1);
            }
        });
...
//            }
    ...
    private void getViewResource() {
        ...
        titles[0] = intro_title;
        titles[1] = intro5_title;
        titles[2] = intro2_title;
        titles[3] = intro3_title;
        titles[4] = intro4_title;
        titles[5] = intro7title;
    }
