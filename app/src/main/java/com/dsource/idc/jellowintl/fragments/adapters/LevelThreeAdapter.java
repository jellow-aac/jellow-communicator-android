package com.dsource.idc.jellowintl.fragments.adapters;
...
public class LevelThreeAdapter extends RecyclerView.Adapter<LevelThreeAdapter.MyViewHolder>{
    ...
    private final LevelThreeFragment mFragment;
    ...
    public LevelThreeAdapter(LevelThreeFragment fragment, String[] iconCodes, Icon[] level3IconObjects, Integer[] sort, int length) {
        mFragment = fragment;
        ...
        if (fragment.isCategoryWithPreference() && level3IconObjects.length == iconCodes.length) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (iconNameArray[position].equals(ADD_BASIC_CUSTOM_ICON)){
            Glide.with(mContext).load(R.drawable.ic_plus).into(holder.menuItemImage);
        }
        ...
        if(position >=libIconSize
            ...
            holder.listItemEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mFragment != null) {
                        mFragment.onEditIconClicked(position);
                    }
                }
            });
            holder.listItemDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mFragment != null) {
                        mFragment.onDeleteIconClicked(position);
                    }
                }
            });
        }
        ...
        holder.menuItemLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mFragment != null) {
                    mFragment.tappedCategoryItemEvent(holder.menuItemLinearLayout, position);
                }
            }
        });
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder  {
        ...
        MyViewHolder(final View view) {
            ...
            if (mFragment != null && mFragment.getLevelActivity() != null) {
                isTalkback = mFragment.getLevelActivity().isAccessibilityTalkBackOn((AccessibilityManager) mContext.getSystemService(ACCESSIBILITY_SERVICE));
            }
            if(isTalkback) {
