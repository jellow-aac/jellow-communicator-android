...
public class ProfileFormFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getAppActivity().setupActionBarTitle(view, View.VISIBLE, getString(R.string.home)+"/ "+getString(R.string.menuProfile));
    ...
    public void onResume() {
        super.onResume();
        getAppActivity().setVisibleAct(ProfileFormFragment.class.getSimpleName());
        getAppActivity().setupActionBarTitle(getView(), View.VISIBLE, getString(R.string.home)+"/ "+getString(R.string.menuProfile));
    ...
    private void savedProfileDetails() {
        ...
        NavHostFragment.findNavController(ProfileFormFragment.this).popBackStack();
    }
}
